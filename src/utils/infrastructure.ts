...
export const fleetRegionCards: FleetRegionCard[] = [
  ...
  },
  {
    ...
    providerEn: 'GitHub Pages',
    role: 'Showcase',
    roleEn: 'Showcase',
    description: '基于 GitHub Pages 部署的公开静态名片，对外展示你的历史与身份。',
    descriptionEn: 'The personal static profile deployed on GitHub Pages.',
    hostNodeIds: ['github-pages-host'],
    serviceNodeIds: ['github-profile-site'],
    accentClass: 'from-stone-500/24 via-slate-500/10 to-transparent',
    providerClass: 'border-slate-400/25 bg-slate-500/10 text-slate-300',
    roleClass: 'border-stone-400/25 bg-stone-500/10 text-stone-300',
  },
  {
    id: 'cloudflare-showcase',
    region: 'Global',
    regionEn: 'Global',
    provider: 'Cloudflare Pages',
    providerEn: 'Cloudflare Pages',
    role: 'Showcase',
    roleEn: 'Showcase',
    description: '基于 Cloudflare Pages 部署的 digital-biome，承载个人网站与数字资产门户。',
    descriptionEn: 'The personal website and digital asset portal deployed on Cloudflare Pages.',
    hostNodeIds: ['cloudflare-pages-host'],
    serviceNodeIds: ['digital-biome-site'],
    accentClass: 'from-amber-500/24 via-orange-500/10 to-transparent',
    providerClass: 'border-orange-400/25 bg-orange-500/10 text-orange-300',
    roleClass: 'border-amber-400/25 bg-amber-500/10 text-amber-300',
  },
];
